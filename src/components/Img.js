...
export default function Img(props) {
    ...
    return (
        <div className='imgBox' onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)}>
            {isShown && (
                <div className='eyeDiv'>
                    <svg  style={{}} className='eyeImg' width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
